...
class CalendarTest {
    ...
    void createCalendar() throws IOException {
        ...
        assertEquals("Calendar[startWorkingHours=09:00, endWorkingHours=19:55, meetings=[Meeting[startTime=09:00, endTime=10:30], Meeting[startTime=12:00, endTime=13:00], Meeting[startTime=16:00, endTime=18:00]]]",
                cal1.toString());
        assertEquals("Calendar[startWorkingHours=10:00, endWorkingHours=18:30, meetings=[Meeting[startTime=14:30, endTime=15:00], Meeting[startTime=10:00, endTime=11:30], Meeting[startTime=12:30, endTime=14:30], Meeting[startTime=16:00, endTime=17:00]]]",
                cal2.toString());
    }
